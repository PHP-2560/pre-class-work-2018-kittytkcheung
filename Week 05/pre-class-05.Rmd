...
for (i in 1:nrow(wcgs)) {
    if (wcgs[i, "typchd69"] == "no CHD") {
      noCHD = c()
      noCHD = append(noCHD, wcgs[i,"weight"])
    } else if (wcgs[i, "typchd69"] == "MI or SD") {
      misd = c()
      misd = append(misd, wcgs[i,"weight"])
    } else if (wcgs[i, "typchd69"] == "angina") {
      ang = c()
      ang = append(ang, wcgs[i,"weight"])
    } else if (wcgs[i, "typchd69"] == "silent MI") {
      smi = c()
      smi = append(smi, wcgs[i,"weight"])
    } 
  }

print(paste0("silent MI ", mean(smi), "    angina ", mean(ang), "    MI or SD ", mean(misd), "    no CHD ", mean(noCHD)))
```
