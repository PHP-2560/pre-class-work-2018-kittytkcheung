...
Albania
```{r}
eur_1997 <- filter(europe, year == 1997)
which.min(eur_1997$gdpPercap)
```

According to the data available, what was the average life expectancy across each continent in the 1980s?
52.469 years in Africa, 63.735 in Asia, 73.224 in Europe, 67.16 in Americas, and 74.805 in Oceania.
``` {r}
